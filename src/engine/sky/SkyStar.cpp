...
extern "C" float gVRSkyCloudM200; // VR sky-remap calibration - see SkyCloud.cpp (stars share the formula)
...
void SkyStar::Tick() {
    ...
    // star tracks (Rainbow Road) calibrate from THEIR live fov instead of a stale value from a prior track.
